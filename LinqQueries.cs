public class LinqQueries
{
    ...
    // Is the same for LongCount and Count
    ...
    public ILookup<string, Book> DiccionariosDeLibrosPorAñoDePublicacion()
    {
        return librosCollection.ToLookup(p => p.PublishedDate.Year.ToString(), p => p);
    }
